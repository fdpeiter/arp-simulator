...
class EchoPacket:
    def __init__(self, src_host, src_mac, src_address, dst_host, dst_mac, dst_address, ttl=8):
        assert isinstance(src_mac, netaddr.EUI), "Source MAC format invalid"
        assert isinstance(dst_mac, netaddr.EUI), "Destination MAC format invalid"
